# Project 1: IAM Cross-Account Access & Identity Governance
...
**Framework/Regulation:** ISO 27001 A.9, NIST SP 800-53 AC-2/AC-6, CIS AWS Benchmark 1.x  
**Project Type:** Fictional Portfolio Case Study  

> **Scenario Context:** Apex Cloud Financial Systems (ApexPay) – Cross-Account Governance  

## Project Deliverables Index
- 🏗️ **IAM Governance Terraform Code:** [`terraform/main.tf`](./terraform/main.tf)
- 📋 **IAM Policy Governance Standard:** [`docs/iam_governance_policy.md`](./docs/iam_governance_policy.md)
- 🔎 **Quarterly Access Review Evidence:** [`evidence/QUARTERLY_ACCESS_REVIEW_EVIDENCE.md`](./evidence/QUARTERLY_ACCESS_REVIEW_EVIDENCE.md)
- 💬 **Auditor Challenge Q&A:** [`docs/auditor_qa_iam.md`](./docs/auditor_qa_iam.md)
